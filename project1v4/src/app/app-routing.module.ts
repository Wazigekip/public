...
const routes: Routes = [
  ...
  { path: 'horror/:id', component: WakkerdamHorrorVariantComponent },
	...
	{ path: 'rolberichtenuitvoer/:id/:dag/:aantal', component: RolberichtenUitvoerComponent },
	...
	{ path: 'dodentopicuitvoer/:id/:dag', component: DodentopicUitvoerComponent },
	{ path: 'nieuwspel/:id', component: NieuwSpelComponent },
	{ path: 'nieuwespeler', component: NieuweSpelerComponent }
];
